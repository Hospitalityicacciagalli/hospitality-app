...
import { Users, CalendarDays, Menu } from 'lucide-react'
...
function Layout() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside
        className={
          "fixed inset-y-0 left-0 z-30 w-64 bg-wine-800 text-white transform transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 " +
